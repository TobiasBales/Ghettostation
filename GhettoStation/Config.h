...
//#define BAUDRATES // allow choosing baudrate using the menu
#define FORCE_BAUDRATE 0 // force baudrate when it is not choosable via menu, see GhettoStation.h -> baudrates for values

//#define PROTOCOLS // allow choosing telemetry protocol using the menu
#define FORCE_PROTOCOL 2 // force telemetry protocol, 0: UAVTalk, 1: MSP, 2: LTM, 3: Mavlink, 4: NMEA, 5: UBLOX

//#define BEARING_METHODS // allow choosing bearing method using the menu
#define FORCE_BEARING_METHOD 1 // force bearing method, 1: 20 Meters, 2: Manual, 3: FC Compass, 4: GS Compass

//#define PROFILES // allow using multiple profiles
#ifdef PROFILES
